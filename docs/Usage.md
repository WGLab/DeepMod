**This is an explanation of how to use DeepMod without examples. If you want to run some example, please refer to [demo](https://github.com/WGLab/DeepMod/blob/master/docs/Reproducibility.md).**
