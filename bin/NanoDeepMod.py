...
com_group_for_comparison.add_argument("--recursive", type=int, default=0, choices=[0,1], help="Recurise to find fast5 files. Default:1")
com_group_for_comparison.add_argument("--threads", type=int, default=1, help="The number of threads used (not for train). Default:12")
com_group_for_comparison.add_argument("--files_per_thread", type=int, default=4000, help="The number of fast5 files for each thread (not for train). Default:4000")
com_group_for_comparison.add_argument("--windowsize", type=int, default=11, help="The window size to extract features. Default: 11")
...
parser_getfeatures.add_argument("--size_per_batch", type=int, default=3, help="The size (unit: 10^7=10M) of a feature file. Default: 7")
...
parser_getfeatures.add_argument("--motifORPos", type=int, default=1, help="Use Motif or pos for modified bases. Default: 1(Motif) or 2 (Pos)")
